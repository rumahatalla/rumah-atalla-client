          ...
          <div className="container px-5 py-24 mx-auto">
            <div className=" sm:w-4/5 lg:w-3/5 w-full mx-auto text-center">
              ...
              <p className="leading-relaxed text-sm sm:text-lg">
                ...
                menjadi cinta yang menyentuh jiwa. Kami memahami bahwa keindahan
                bukanlah sekadar penampilan luar, tetapi juga sebuah pengalaman
                yang meresap dalam hati. Di Rumah Atalla, kami mengajak Anda
                untuk menemukan harmoni antara gaya dan kenikmatan, menciptakan
                cerita indah dalam setiap detik yang kami bagi bersama Anda.
              </p>
